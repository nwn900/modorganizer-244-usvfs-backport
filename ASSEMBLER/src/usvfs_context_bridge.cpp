...
struct HookContextProxy
{
  ...
  using Ptr     = std::unique_ptr<usvfs::HookContext, void (*)(usvfs::HookContext*)>;
        ...
        m_DebugMode(params.debugMode), m_DLLModule(module)
  {
    ...
    usvfs::HookContext::s_Instance = reinterpret_cast<usvfs::HookContext*>(this);
  ...
  SharedParameters* retrieveParameters(const usvfsParameters& params)
  {
    ...
    if (res.first == nullptr) {
      ...
      spdlog::get("usvfs")->info("access existing config in {}",
                                 ::GetCurrentProcessId());
    }
...
struct HookManagerProxy
{
      ...
      : m_Context(params, module)
  {
    ...
    usvfs::HookManager::s_Instance = reinterpret_cast<usvfs::HookManager*>(this);
  ...
  void installHook(HMODULE module1, HMODULE module2, const std::string& functionName,
                   LPVOID hook, LPVOID* fillFuncAddr = nullptr)
  {
...
extern "C" usvfs::HookContext*
usvfsAsmHookContextCtorImpl(usvfs::HookContext* self, const usvfsParameters& params,
                            HMODULE module)
{
...
extern "C" void usvfsAsmHookContextRegisterProcessImpl(usvfs::HookContext* self,
                                                       DWORD pid)
{
  self->m_Parameters->registerProcess(pid);
}

void usvfs::HookContext::setDebugParameters(LogLevel level, CrashDumpsType dumpType,
                                            const std::string& dumpPath,
                                            std::chrono::milliseconds delayProcess)
{
...
extern "C" void
usvfsAsmHookContextUnregisterCurrentProcessImpl(usvfs::HookContext* self)
{
...
extern "C" void usvfsAsmHookContextBlacklistExecutableImpl(usvfs::HookContext* self,
                                                           const std::wstring& wexe)
{
...
extern "C" void
usvfsAsmHookContextClearExecutableBlacklistImpl(usvfs::HookContext* self)
{
...
extern "C" BOOL
usvfsAsmHookContextExecutableBlacklistedImpl(const usvfs::HookContext* self,
                                             LPCWSTR wapp, LPCWSTR wcmd)
{
  std::string app;
  if (wapp) {
...
extern "C" void usvfsAsmHookContextForceLoadLibraryImpl(usvfs::HookContext* self,
                                                        const std::wstring& wprocess,
...
extern "C" void usvfsAsmHookContextClearLibraryForceLoadsImpl(usvfs::HookContext* self)
{
...
{
  m_Parameters->addSkipFileSuffix(
...
{
  m_Parameters->addSkipDirectory(
      shared::string_cast<std::string>(directory, shared::CodePage::UTF8));
}
...
usvfs::HookContext::librariesToForceLoad(const std::wstring& processName)
{
...
extern "C" void usvfsAsmHookContextRegisterDelayedImpl(usvfs::HookContext* self,
...
extern "C" void usvfsAsmHookContextUnlockSharedImpl(const usvfs::HookContext* self)
{
  self->m_Mutex.signal();
}

extern "C" SharedParameters*
usvfsAsmHookContextRetrieveParametersImpl(usvfs::HookContext* self,
                                          const usvfsParameters& params)
{
  return asHookContext(self)->retrieveParameters(params);
}

extern "C" usvfs::HookManager*
usvfsAsmHookManagerCtorImpl(usvfs::HookManager* self, const usvfsParameters& params,
                            HMODULE module)
{
...
extern "C" LPVOID usvfsAsmHookManagerDetourImpl(usvfs::HookManager* self,
                                                const char* functionName)
{
  return asHookManager(self)->detour(functionName);
}

extern "C" void usvfsAsmHookManagerRemoveHookImpl(usvfs::HookManager* self,
                                                  const std::string& functionName)
{
  asHookManager(self)->removeHook(functionName);
}

extern "C" void usvfsAsmHookManagerLogStubIntImpl(usvfs::HookManager* self,
                                                  LPVOID address)
{
...
extern "C" void usvfsAsmHookManagerInstallHookImpl(usvfs::HookManager* self,
                                                   HMODULE module1, HMODULE module2,
                                                   const std::string& functionName,
                                                   LPVOID hook, LPVOID* fillFuncAddr)
{
  asHookManager(self)->installHook(module1, module2, functionName, hook, fillFuncAddr);
}

extern "C" void usvfsAsmHookManagerInstallStubImpl(usvfs::HookManager* self,
                                                   HMODULE module1, HMODULE module2,
                                                   const std::string& functionName)
{
